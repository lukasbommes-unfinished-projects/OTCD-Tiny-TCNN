...
def bbox_transform_inv_corrected(boxes, deltas, batch_size=None, sigma=1/math.sqrt(2)):
    """corrected version of `bbox_transform_inv` which does not enlarge box by 1px
       when dw = dh = 0.
    """
